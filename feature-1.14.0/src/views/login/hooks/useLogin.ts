 ...
 * @LastEditTime: 2022-03-30 19:02:01
 * @LastEditors: 宋绍华
 * @Description:
...
const CONFIG = {
  ...
  // agentid: process.env.NODE_ENV === "development" ? "1000131" : "1000131",
  // redirect_uri: process.env.NODE_ENV === "development" ? encodeURIComponent("https://test.tomato.rvet.cn") : encodeURIComponent("https://test.tomato.rvet.cn"),
  agentid: process.env.NODE_ENV === "development" ? "1000131" : "1000089",
  redirect_uri: process.env.NODE_ENV === "development" ? encodeURIComponent("https://test.tomato.rvet.cn") : encodeURIComponent("https://tomato.petrvet.com"),
  state: "",
  href: ""
};
    ...
    if (code) {
      ...
      try {
        ...
        if (getSession("jumpUrl") && getSession("jumpUrl") !== "/login") {
          ...
          // location.href = `/#/project/iteration/homepage`;
