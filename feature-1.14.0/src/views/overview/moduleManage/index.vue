    ...
    <el-row :gutter="20">
      ...
      <el-col :span="14">
        <div class="grid-content bg-purple" style="border-left: 1px solid #ccc">
          ...
          <page-table :tableData="list" @handlePagationChange="getTableData" :total="total" ref="pageTableRef" :stopAutoGetData="stopAutoGetData">
            <template #main>
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleRemove = (node: Record<string, any>, data: Record<string, any>) => {
      ElMessageBox.confirm("删除模块后，当前模块下需求会关联到父级，操作不可逆，是否确认？", "删除模块", {
