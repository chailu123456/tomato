<template>
  <div class="overview" id="overview" :class="{ isFullScreen: isFullScreen }">
    <page-table :tableData="list" :tableRowClassName="tableRowClassName" @handlePagationChange="getData" :total="total" ref="pageTableRef">
      <template #header>
        <el-form :inline="true" :model="searchParams">
          <el-form-item label="迭代名称">
            <el-input v-model="searchParams.name" @clear="handleClear" @keyup.enter="handleConditionSearch" clearable placeholder="请输入迭代名称"></el-input>
          </el-form-item>
        ...
        <span class="fullscreen-icon iconfont icon-fullscreen" @click="handleFullscreen"></span>
      </template>
      <template #main>
