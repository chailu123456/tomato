<template>
  <div v-if="searchParams.demand" class="statistics">
    <!--第一行-->
    <el-row :gutter="10">
      <el-col :span="12">
        <div class="board">
...
export default defineComponent({
  ...
  setup() {
    ...
    const getData = async () => {
      console.log(searchParams.demand, "searchParams.demandsearchParams.demandsearchParams.demand");
      const {
        staff_count,
        total_hour,
        total_task,
      ...
      } = await getChartData(searchParams.demand);
      // 迭代任务
