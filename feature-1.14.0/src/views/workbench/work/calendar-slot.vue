<template>
  <div class="work-calendar" @click.stop="showDialog" :style="`height: ${calItemHeight || ''}px`">
    ...
    <CalendarSlotTasks @handleItem="showCurTips(2, $event)" :data="data" :list="calendarItems" v-model:tasksVisible="tasksVisible" />
