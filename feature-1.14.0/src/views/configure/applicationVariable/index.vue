    ...
    <page-table :tableData="list" @handlePagationChange="getData" :total="total" ref="pageTableRef" :stopAutoGetData="stopAutoGetData">
      ...
      <template #main>
        ...
        <el-table-column label="操作">
          <template #default="scoped">
            <el-button type="text" @click="handleCopyUrl(scoped.row.git_url)">复制源码地址</el-button>
            <el-button type="text" @click="handleUpdateApp(1, scoped.row)">编辑</el-button>
            <el-button class="delete" type="text" @click="handleDelete(scoped.row)">删除</el-button>
          </template>
        </el-table-column>
      </template>
    </page-table>
