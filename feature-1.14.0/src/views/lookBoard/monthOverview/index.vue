        ...
        <div class="statistics-left">
          <el-form :inline="true" :model="searchCriteria">
            <el-select
              ...
              class="statistics-project statistics-project-list"
              value-key="id"
              v-model="searchCriteria.product_id"
              filterable
              placeholder="请选择"
            >
        ...
        <div class="statistics-right">
          <ul class="statistics-tab-list">
            ...
            <li class="tab-detail">
              ...
              <div class="detail-foot-num">
                <span>未完成工时 {{ tabList.un_fixed_task_hour_num }} h，</span>
                <span>准点率 {{ tabList.task_precision_rate }} %</span>
              </div>
            </li>
            <li class="tab-detail">
              <div class="tab-detail-title">
      ...
      <div class="month-table-content">
        <div class="overflow-title">
          ...
          <span class="right-jump">
            <router-link
              target="_blank"
              class="table-link jump-page"
              :to="`/lookBoard/project/qualityOverview?product_id=${searchCriteria.product_id}&month=${searchCriteria.month}`"
            >
              在项目-质量概览中查看
            </router-link>
        ...
        <div class="overflow-title">
          ...
          <span class="right-jump">
            <router-link
              target="_blank"
              class="table-link jump-page"
              :to="`/lookBoard/personal/jobEvaluation?product_id=${searchCriteria.product_id}&month=${searchCriteria.month}`"
        ...
        <!-- <div class="more-view">
        <div class="overflow-title">
          <span style="margin-left: 4px">更多视图</span>
        </div>
        <MoreView></MoreView>
      </div> -->
      </div>
...
const { searchParams } = useMixin(true);
...
//成员工作质量默认最大高度
const jobEvaluationVal = ref(440);
...
:deep(.job-evaluation-table) {
  height: v-bind(jobEvaluationVal + "px") !important;
}
</style>
