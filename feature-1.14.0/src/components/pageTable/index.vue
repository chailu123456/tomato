...
export default defineComponent({
  ...
  emits: ["handlePagationChange", "handlePagationAdd", "handleRow", "handleSelectionChange", "sortChange"],
  setup(props, { emit }) {
    ...
    const getHeight = () => {
      ...
      nextTick(() => {
        ...
        if (route.path === "/lookBoard/personal/jobEvaluation") {
          height.value = content.value.offsetHeight - header.value.offsetHeight - 200;
          return;
        }
