!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      (e.isChunkExpired = o),
        ...
        (e.getUploadUrl = function (t, e) {
          var n = p();
          if (null != t.uphost) return h.default.resolve(n + "//" + t.uphost);
          if (null != t.region) {
            var r = y.regionUphostMap[t.region],
              o = t.useCdnDomain ? r.cdnUphost : r.srcUphost;
            return h.default.resolve(n + "//" + o);
          }
          return (function (t) {
            try {
              var e = (function (t) {
              ...
              return l(p() + "//api.qiniu.com/v2/query?ak=" + e.ak + "&bucket=" + e.bucket, {
                method: "GET"
              });
            } catch (t) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, d, g, m, v) {
        ...
        var y,
          ...
          F = U || x(g),
          I = g ? (_ ? x("entries") : F) : void 0,
          k = ("Array" == e && C.entries) || U;
        if (
          (k && (w = f(k.call(new t()))) !== Object.prototype && w.next && (c(w, S, !0), r || "function" == typeof w[l] || a(w, l, h)),
          _ &&
            U &&
            "values" !== U.name &&
            ((P = !0),
          ...
          return (t = (function (t) {
            ...
            do {
              (n = t.charCodeAt(f++)),
                ...
                (s = (c >> 6) & 63),
                (u = 63 & c),
                (h[l++] = e.charAt(i) + e.charAt(a) + e.charAt(s) + e.charAt(u));
            } while (f < t.length);
          ...
          return (function (t) {
            ...
            do {
              (i = e.indexOf(t.charAt(f++))),
                ...
                (r = (c >> 8) & 255),
                (o = 255 & c),
                (p[l++] = 64 === s ? String.fromCharCode(n) : 64 === u ? String.fromCharCode(n, r) : String.fromCharCode(n, r, o));
            } while (f < t.length);
            return p.join("");
    ...
    function (t, e, n) {
      ...
      (e.__esModule = !0),
        (e.pipeline =
          ...
          e.getUploadUrl =
          e.filterParams =
          e.getHeadersForMkFile =
          e.getResumeUploadedSize =
    ...
    function (t, e, n) {
      ...
      M ||
        ((F = function (t) {
          d(this, F, "Promise", "_h"), h(t), r.call(this);
          try {
    ...
    function (t, e, n) {
      ...
      ((e = t.exports =
        function (t, e, n, l, p) {
          ...
          if (i(v)) {
            for (h = s(t.length); h > b; b++) if ((m = e ? y(a((d = t[b]))[0], d[1]) : y(t[b])) === c || m === f) return m;
        ...
        n(10)(function () {
          ...
          ? function (t, e) {
              for (var n = a(t), u = arguments.length, c = 1, f = o.f, l = i.f; u > c; )
                for (var p, h = s(arguments[c++]), d = f ? r(h).concat(f(h)) : r(h), g = d.length, m = 0; g > m; ) l.call(h, (p = d[m++])) && (n[p] = h[p]);
              return n;
            }
          : u;
    },
    ...
    function (t, e, n) {
      ...
      var o = r(n(18)),
        ...
        l = Math.log(2),
        p = (0, s.default)(f).map(function (t) {
          return f[t];
        }),
        h = f.JPEG,
        d = (function () {
          ...
          return (
            ...
            (t.prototype.clear = function (t, e, n) {
              this.outputType === h ? ((t.fillStyle = "#fff"), t.fillRect(0, 0, e, n)) : t.clearRect(0, 0, e, n);
            }),
            ...
            (t.prototype.doScale = function (t, e) {
              ...
              for (var h = void 0, d = void 0, g = 0; g < r; g++) {
                var m = (u * i) | 0,
                  v = (c * i) | 0;
                g === r - 1 && ((m = f * e), (v = p * e)),
                  g % 2 == 0 ? ((h = t), (d = s)) : ((h = a), (d = n)),
                  this.clear(d, u, c),
                  d.drawImage(h, 0, 0, u, c, 0, 0, m, v),
                  (u = m),
                  (c = v);
              }
              var y = h === t ? a : t,
                  ...
                  for (var n = 2, r = t.byteLength, o = new DOMParser(); n < r - 4; ) {
                    if ("http" == f(e, n, 4)) {
                      ...
                      s =
                        ...
                        s.slice(c);
                      return h(o.parseFromString(s, "text/xml"));
                    }
                    n++;
                  }
                }
        ...
        function c(t, e, n, r, o) {
          ...
          switch (p) {
            ...
            case 7:
              ...
              for (i = h > 4 ? d : e + 8, a = [], u = 0; u < h; u++) a[u] = t.getUint8(i + u);
              return a;
            case 2:
              return f(t, (i = h > 4 ? d : e + 8), h - 1);
            case 3:
              if (1 == h) return t.getUint16(e + 8, !o);
              for (i = h > 2 ? d : e + 8, a = [], u = 0; u < h; u++) a[u] = t.getUint16(i + 2 * u, !o);
              return a;
            case 4:
              if (1 == h) return t.getUint32(e + 8, !o);
              for (a = [], u = 0; u < h; u++) a[u] = t.getUint32(d + 4 * u, !o);
              return a;
            case 5:
              if (1 == h) return (c = t.getUint32(d, !o)), (l = t.getUint32(d + 4, !o)), ((s = new Number(c / l)).numerator = c), (s.denominator = l), s;
              for (a = [], u = 0; u < h; u++)
            ...
            case 9:
              ...
              for (a = [], u = 0; u < h; u++) a[u] = t.getInt32(d + 4 * u, !o);
              return a;
            case 10:
              if (1 == h) return t.getInt32(d, !o) / t.getInt32(d + 4, !o);
              for (a = [], u = 0; u < h; u++) a[u] = t.getInt32(d + 8 * u, !o) / t.getInt32(d + 4 + 8 * u, !o);
              return a;
          }
        }
