...
import { defineProps, ref, reactive, onMounted, computed, defineEmits, watch } from "vue";
import { DEMAND_PRIORITY, requireTypes, DEMAND_STATUS } from "@/utils/contantOptions";
import { ResponseParams } from "@/types/response";
import type { FormInstance, FormRules } from "element-plus";
import { getSettingModule, selectProductList, editDemand } from "@/api/request-modules/product";
