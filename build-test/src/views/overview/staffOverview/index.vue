...
export default defineComponent({
  ...
  setup() {
    ...
    const { getData, tableData, stopAutoGetData, currentPage } = useGetEmployeeCalendarList(useFetchSearch, searchParams);
...
:global(.staffoverview .el-table__cell) {
