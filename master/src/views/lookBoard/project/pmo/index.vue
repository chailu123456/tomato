<template>
  <div class="overview pmo" id="overview">
    <page-table
      :tableData="list"
    ...
    >
      ...
      <template #main>
        <el-table-column prop="product_name" label="项目" sortable="custom" fixed="left" min-width="100"></el-table-column>
        <el-table-column prop="name" label="版本名称" sortable="custom" fixed="left" class-name="table-column-left table-column-left1" min-width="150">
          <template #default="scope">
            <span class="version__color" @click="handleShowDetail(scope.row)">{{ scope.row.name }}</span>
          </template>
        </el-table-column>
        <el-table-column label="迭代内容" class-name="table-column-left" fixed="left" min-width="220">
          <!-- demand -->
          <template #default="scope">
        ...
        <el-table-column label="成员" width="170" fixed="left" class-name="table-column-left">
          <template #default="scope">
        ...
        <el-table-column label="迭代进度" min-width="160" fixed="left" prop="complete_percent" sortable="custom">
          <template #default="scope">
            <span>
