    ...
    <span>
      <el-form :model="formData" label-width="100px" label-position="top" :rules="rules" ref="ruleFormRef">
        ...
        <div class="flex-layout">
          <el-form-item label="产品负责人" label-width="100px" prop="iteration_manager.staff_no">
            <el-select v-model="formData.iteration_manager.staff_no" filterable placeholder="请选择" @change="setFiled($event, 'iteration_manager')">
          ...
          <el-form-item label="后端负责人" label-width="100px" prop="backend_manager.staff_no">
            <el-select v-model="formData.backend_manager.staff_no" filterable placeholder="请选择" @change="setFiled($event, 'backend_manager')">
              <el-option-group v-for="group in employeeLists" :key="group.staff_no" :label="group.label">
                <el-option v-for="item in group.options" :key="item.staff_no" :label="item.staff_name" :value="item.staff_no"></el-option>
              </el-option-group>
            </el-select>
          </el-form-item>
          <el-form-item label="前端负责人" label-width="100px" prop="frontend_manager.staff_no">
            <el-select v-model="formData.frontend_manager.staff_no" filterable placeholder="请选择" @change="setFiled($event, 'frontend_manager')">
              <el-option-group v-for="group in employeeLists" :key="group.staff_no" :label="group.label">
                <el-option v-for="item in group.options" :key="item.staff_no" :label="item.staff_name" :value="item.staff_no"></el-option>
              </el-option-group>
            </el-select>
          </el-form-item>
          <el-form-item label="测试负责人" label-width="100px" prop="test_manager.staff_no">
            <el-select v-model="formData.test_manager.staff_no" filterable placeholder="请选择" @change="setFiled($event, 'test_manager')">
              <el-option-group v-for="group in employeeLists" :key="group.staff_no" :label="group.label">
                <el-option v-for="item in group.options" :key="item.staff_no" :label="item.staff_name" :value="item.staff_no"></el-option>
              </el-option-group>
            </el-select>
