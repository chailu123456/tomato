 ...
 * @LastEditTime: 2022-07-26 21:02:57
 * @LastEditors: 宋绍华
 * @Description:
...
import { clearCookie, getDomain, getFirstName, getSession } from "@/utils";
...
const showDropdown = computed(() => {
  ...
  return addColumnList.value.length && (firstName === "document" || !!productId.value);
});
