 ...
 * @LastEditTime: 2022-08-12 11:07:11
 * @LastEditors: 宋绍华
 * @Description:
...
const getActive = (route: typeof currentRt.routeMap.lookBoard[0]) => {
  ...
  if (
    ...
    (currentRoute.value === "/project/product/demandDoc" && route.id === 1) ||
    (currentRoute.value === "/project/product/planDetail" && route.id === 1) ||
...
const linkToPage = (n: typeof currentRt.routeMap.lookBoard[0]) => {
  ...
  router.push({
    ...
    query: {
      ...query,
      productId: firstName === "project" ? productId.value : undefined
    }
  });
};
</script>
